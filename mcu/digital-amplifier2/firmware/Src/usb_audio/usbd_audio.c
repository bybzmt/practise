...
static uint8_t VOL_16to8(int16_t vol);
static int16_t VOL_8to16(uint8_t vol);
            ...
            case AUDIO_CONTROL_REQ_FU_VOL:
                {
                    ...
                    int16_t _vol = VOL_8to16(settings.vol);
                    USBD_CtlSendData(pdev, (uint8_t*)&_vol, 2);
                };
                break;
        }
